...
check-lang-mutants-core-diagnostics:
  {{runner}} --timeout-secs {{mutants_timeout}} --label "abide-core diagnostic mutants" -- {{mutants_env}} cargo mutants {{mutants_common_args}} -p abide-core --file crates/abide-core/src/diagnostic.rs --output mutants.out.core-diagnostics -- --lib diagnostic {{mutants_libtest_args}}

check-lang-mutants-core-support:
  {{runner}} --timeout-secs {{mutants_timeout}} --label "abide-core span/message mutants" -- {{mutants_env}} cargo mutants {{mutants_common_args}} -p abide-core --file crates/abide-core/src/span.rs --file crates/abide-core/src/messages.rs --output mutants.out.core-support -- --lib {{mutants_libtest_args}}
...
check-lang-mutants-witness-operational:
  {{runner}} --timeout-secs {{mutants_timeout}} --label "abide-witness operational mutants" -- {{mutants_env}} cargo mutants {{mutants_common_args}} -p abide-witness --file crates/abide-witness/src/op.rs --output mutants.out.witness-operational -- --lib op {{mutants_libtest_args}}

check-lang-mutants-witness-relational-values:
  {{runner}} --timeout-secs {{mutants_timeout}} --label "abide-witness relational/value mutants" -- {{mutants_env}} cargo mutants {{mutants_common_args}} -p abide-witness --file crates/abide-witness/src/rel.rs --file crates/abide-witness/src/value.rs --output mutants.out.witness-relational-values -- --lib {{mutants_libtest_args}}

check-lang-mutants-witness-envelopes:
  {{runner}} --timeout-secs {{mutants_timeout}} --label "abide-witness envelope/evidence mutants" -- {{mutants_env}} cargo mutants {{mutants_common_args}} -p abide-witness --file crates/abide-witness/src/shared.rs --file crates/abide-witness/src/evidence.rs --output mutants.out.witness-envelopes -- --lib {{mutants_libtest_args}}
...
check-lang-mutants-syntax-core-shard shard:
  {{runner}} --timeout-secs {{mutants_timeout}} --label "abide-syntax parser core mutants shard {{shard}}/{{mutants_shard_total}}" -- {{mutants_env}} cargo mutants {{mutants_common_args}} --shard "$(({{shard}} - 1))/{{mutants_shard_total}}" -p abide-syntax --file crates/abide-syntax/src/parse/mod.rs --output mutants.out.syntax-core.{{shard}}-of-{{mutants_shard_total}} -- --lib parse {{mutants_libtest_args}}
...
check-lang-mutants-syntax-expr-shard shard:
  {{runner}} --timeout-secs {{mutants_timeout}} --label "abide-syntax expression parser mutants shard {{shard}}/{{mutants_shard_total}}" -- {{mutants_env}} cargo mutants {{mutants_common_args}} --shard "$(({{shard}} - 1))/{{mutants_shard_total}}" -p abide-syntax --file crates/abide-syntax/src/parse/expr.rs --output mutants.out.syntax-expr.{{shard}}-of-{{mutants_shard_total}} -- --lib parse {{mutants_libtest_args}}

check-lang-mutants-syntax-system:
  {{runner}} --timeout-secs {{mutants_timeout}} --label "abide-syntax system parser mutants" -- {{mutants_env}} cargo mutants {{mutants_common_args}} -p abide-syntax --file crates/abide-syntax/src/parse/system.rs --output mutants.out.syntax-system -- --lib parse {{mutants_libtest_args}}

check-lang-mutants-syntax-types:
  {{runner}} --timeout-secs {{mutants_timeout}} --label "abide-syntax type parser mutants" -- {{mutants_env}} cargo mutants {{mutants_common_args}} -p abide-syntax --file crates/abide-syntax/src/parse/types.rs --output mutants.out.syntax-types -- --lib parse {{mutants_libtest_args}}
...
check-lang-mutants-sema-namespace-shard shard:
  {{runner}} --timeout-secs {{mutants_timeout}} --label "abide-sema namespace mutants shard {{shard}}/{{mutants_shard_total}}" -- {{mutants_env}} cargo mutants {{mutants_common_args}} --shard "$(({{shard}} - 1))/{{mutants_shard_total}}" -p abide-sema --file crates/abide-sema/src/elab/env.rs --re 'build_working_namespace|key_matches_module|flatten_sorted' --output mutants.out.sema-namespace.{{shard}}-of-{{mutants_shard_total}} -- --lib build_working_namespace {{mutants_libtest_args}}
...
check-lang-mutants-sema-loader-shard shard:
  {{runner}} --timeout-secs {{mutants_timeout}} --label "abide-sema loader mutants shard {{shard}}/{{mutants_shard_total}}" -- {{mutants_env}} cargo mutants {{mutants_common_args}} --shard "$(({{shard}} - 1))/{{mutants_shard_total}}" -p abide-sema --file crates/abide-sema/src/loader.rs --output mutants.out.sema-loader.{{shard}}-of-{{mutants_shard_total}} -- --lib loader {{mutants_libtest_args}}
...
check-lang-mutants-sema-resolution-types-core:
  {{runner}} --timeout-secs {{mutants_timeout}} --label "abide-sema type resolution core mutants" -- {{mutants_env}} cargo mutants {{mutants_common_args}} -p abide-sema --file crates/abide-sema/src/elab/resolve/mod.rs --re 'resolve_all_types|resolve_type_refinement_predicates|resolve_ty|resolve_params_lr|base_ty_without_refinement' --output mutants.out.sema-resolution-types-core -- --lib resolve {{mutants_libtest_args}}
...
check-lang-mutants-sema-resolution-types-validate:
  {{runner}} --timeout-secs {{mutants_timeout}} --label "abide-sema unresolved type validation mutants" -- {{mutants_env}} cargo mutants {{mutants_common_args}} -p abide-sema --file crates/abide-sema/src/elab/resolve/validate.rs --re 'validate_remaining_type_params|validate_unresolved_types|collect_ty_params|collect_unresolved' --output mutants.out.sema-resolution-types-validate -- --lib validate {{mutants_libtest_args}}
...
check-lang-mutants-sema-resolution-assumptions-event-path-shard shard:
  {{runner}} --timeout-secs {{mutants_timeout}} --label "abide-sema event path resolution mutants shard {{shard}}/2" -- {{mutants_env}} cargo mutants {{mutants_common_args}} --shard "$(({{shard}} - 1))/2" -p abide-sema --file crates/abide-sema/src/elab/resolve/mod.rs --re 'resolve_event_path' --output mutants.out.sema-resolution-assumptions-event-path.{{shard}}-of-2 -- --lib event_path {{mutants_libtest_args}}
...
check-lang-mutants-sema-checker-system-core-shard shard:
  {{runner}} --timeout-secs {{mutants_timeout}} --label "abide-sema system checker core mutants shard {{shard}}/{{mutants_shard_total}}" -- {{mutants_env}} cargo mutants {{mutants_common_args}} --shard "$(({{shard}} - 1))/{{mutants_shard_total}}" -p abide-sema --file crates/abide-sema/src/elab/check/system.rs --re 'check_system' --output mutants.out.sema-checker-system-core.{{shard}}-of-{{mutants_shard_total}} -- --lib system {{mutants_libtest_args}}

check-lang-mutants-sema-checker-system-interface:
  {{runner}} --timeout-secs {{mutants_timeout}} --label "abide-sema interface conformance mutants" -- {{mutants_env}} cargo mutants {{mutants_common_args}} -p abide-sema --file crates/abide-sema/src/elab/check/system.rs --re 'check_interface_conformance' --output mutants.out.sema-checker-system-interface -- --lib interface {{mutants_libtest_args}}

check-lang-mutants-sema-checker-system-extern:
  {{runner}} --timeout-secs {{mutants_timeout}} --label "abide-sema extern checker mutants" -- {{mutants_env}} cargo mutants {{mutants_common_args}} -p abide-sema --file crates/abide-sema/src/elab/check/system.rs --re 'check_extern' --output mutants.out.sema-checker-system-extern -- --lib check_extern {{mutants_libtest_args}}

check-lang-mutants-sema-checker-system-return:
  {{runner}} --timeout-secs {{mutants_timeout}} --label "abide-sema system return helper mutants" -- {{mutants_env}} cargo mutants {{mutants_common_args}} -p abide-sema --file crates/abide-sema/src/elab/check/system.rs --re 'extract_return_ctor_name|extract_return_payload' --output mutants.out.sema-checker-system-return -- --lib return {{mutants_libtest_args}}

check-lang-mutants-sema-checker-system-proc-deps:
  {{runner}} --timeout-secs {{mutants_timeout}} --label "abide-sema proc dependency checker mutants" -- {{mutants_env}} cargo mutants {{mutants_common_args}} -p abide-sema --file crates/abide-sema/src/elab/check/system.rs --re 'validate_proc_dep_cond' --output mutants.out.sema-checker-system-proc-deps -- --lib proc_dep {{mutants_libtest_args}}
...
check-lang-mutants-sema-checker-ctors:
  {{runner}} --timeout-secs {{mutants_timeout}} --label "abide-sema constructor checker mutants" -- {{mutants_env}} cargo mutants {{mutants_common_args}} -p abide-sema --file crates/abide-sema/src/elab/check/ctors.rs --re 'walk_event_action_for_ctor_check|check_ctor_records_in_expr' --output mutants.out.sema-checker-ctors -- --lib ctor {{mutants_libtest_args}}

check-lang-mutants-sema-diagnostics:
  {{runner}} --timeout-secs {{mutants_timeout}} --label "abide-sema diagnostic mutants" -- {{mutants_env}} cargo mutants {{mutants_common_args}} -p abide-sema --file crates/abide-sema/src/elab/error.rs --output mutants.out.sema-diagnostics -- --lib error {{mutants_libtest_args}}
...
check-lang-mutants-ir-lowering-core:
  {{runner}} --timeout-secs {{mutants_timeout}} --label "abide-ir core lowering mutants" -- {{mutants_env}} cargo mutants {{mutants_common_args}} -p abide-ir --file crates/abide-ir/src/ir/lower/mod.rs --re '{{ir_lowering_core_re}}' --output mutants.out.ir-lowering-core -- --lib lower {{mutants_libtest_args}}

check-lang-mutants-ir-lowering-system:
  {{runner}} --timeout-secs {{mutants_timeout}} --label "abide-ir system lowering mutants" -- {{mutants_env}} cargo mutants {{mutants_common_args}} -p abide-ir --file crates/abide-ir/src/ir/lower/system.rs --re '{{ir_lowering_system_re}}' --output mutants.out.ir-lowering-system -- --lib lower {{mutants_libtest_args}}
...
check-lang-mutants-ir-lowering-expr-shard shard:
  {{runner}} --timeout-secs {{mutants_timeout}} --label "abide-ir expression lowering mutants shard {{shard}}/{{mutants_shard_total}}" -- {{mutants_env}} cargo mutants {{mutants_common_args}} --shard "$(({{shard}} - 1))/{{mutants_shard_total}}" -p abide-ir --file crates/abide-ir/src/ir/lower/expr.rs --re '{{ir_lowering_expr_re}}' --output mutants.out.ir-lowering-expr.{{shard}}-of-{{mutants_shard_total}} -- --lib lower {{mutants_libtest_args}}
...
check-lang-mutants-cli-project-targets-shard shard:
  {{runner}} --timeout-secs {{mutants_cli_timeout}} --label "abide CLI target discovery mutants shard {{shard}}/{{mutants_cli_shard_total}}" -- {{mutants_env}} cargo mutants {{mutants_cli_common_args}} --shard "$(({{shard}} - 1))/{{mutants_cli_shard_total}}" -p abide --file crates/abide/src/targets.rs --output mutants.out.cli-project-targets.{{shard}}-of-{{mutants_cli_shard_total}} -- --lib targets {{mutants_libtest_args}}
...
check-lang-mutants-cli-project-helpers-shard shard:
  {{runner}} --timeout-secs {{mutants_cli_timeout}} --label "abide CLI helper mutants shard {{shard}}/{{mutants_cli_shard_total}}" -- {{mutants_env}} cargo mutants {{mutants_cli_common_args}} --shard "$(({{shard}} - 1))/{{mutants_cli_shard_total}}" -p abide --file crates/abide/src/cli.rs --re '{{cli_project_helpers_re}}' --output mutants.out.cli-project-helpers.{{shard}}-of-{{mutants_cli_shard_total}} -- --lib cli {{mutants_libtest_args}}
...
check-lang-mutants-qa-format:
  {{runner}} --timeout-secs {{mutants_qa_timeout}} --label "abide QA formatting mutants" -- {{mutants_env}} cargo mutants {{mutants_qa_common_args}} -p abide-qa --file crates/abide-qa/src/qa/fmt.rs --re '{{qa_support_re}}' --output mutants.out.qa-format -- --lib fmt {{mutants_libtest_args}}

check-lang-mutants-qa-graph:
  {{runner}} --timeout-secs {{mutants_qa_timeout}} --label "abide QA graph mutants" -- {{mutants_env}} cargo mutants {{mutants_qa_common_args}} -p abide-qa --file crates/abide-qa/src/qa/graph.rs --re '{{qa_support_re}}' --output mutants.out.qa-graph -- --lib graph {{mutants_libtest_args}}

check-lang-mutants-qa-complete:
  {{runner}} --timeout-secs {{mutants_qa_timeout}} --label "abide QA completion mutants" -- {{mutants_env}} cargo mutants {{mutants_qa_common_args}} -p abide-qa --file crates/abide-qa/src/qa/complete.rs --re '{{qa_support_re}}' --output mutants.out.qa-complete -- --lib complete {{mutants_libtest_args}}

check-lang-mutants-qa-validate:
  {{runner}} --timeout-secs {{mutants_qa_timeout}} --label "abide QA validation mutants" -- {{mutants_env}} cargo mutants {{mutants_qa_common_args}} -p abide-qa --file crates/abide-qa/src/qa/validate.rs --re '{{qa_support_re}}' --output mutants.out.qa-validate -- --lib validate {{mutants_libtest_args}}

check-lang-mutants-qa-artifacts:
  {{runner}} --timeout-secs {{mutants_qa_timeout}} --label "abide QA artifact rendering mutants" -- {{mutants_env}} cargo mutants {{mutants_qa_common_args}} -p abide-qa --file crates/abide-qa/src/qa/artifacts.rs --re '{{qa_support_re}}' --output mutants.out.qa-artifacts -- --lib artifacts {{mutants_libtest_args}}
...
check-lang-mutants-lsp-shard shard:
  {{runner}} --timeout-secs {{mutants_lsp_timeout}} --label "abide LSP mutants shard {{shard}}/{{mutants_lsp_shard_total}}" -- {{mutants_env}} cargo mutants {{mutants_lsp_common_args}} --shard "$(({{shard}} - 1))/{{mutants_lsp_shard_total}}" -p abide-lsp --file crates/abide-lsp/src/main.rs --re '{{lsp_re}}' --output mutants.out.lsp.{{shard}}-of-{{mutants_lsp_shard_total}} -- --bin abide-lsp tests {{mutants_libtest_args}}

check-lang-mutants-fn-vc:
  {{runner}} --timeout-secs {{mutants_timeout}} --label "abide-verify function VC mutants" -- {{mutants_env}} cargo mutants {{mutants_common_args}} -p abide-verify --file crates/abide-verify/src/verify/fn_verify.rs --output mutants.out.fn-vc -- --lib fn_contract {{mutants_libtest_args}}

check-lang-mutants-smt-facade:
  {{runner}} --timeout-secs {{mutants_timeout}} --label "abide-verify SMT facade mutants" -- {{mutants_env}} cargo mutants {{mutants_common_args}} -p abide-verify --file crates/abide-verify/src/verify/smt.rs --output mutants.out.smt-facade -- --lib smt {{mutants_libtest_args}}
